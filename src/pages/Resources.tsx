import { Download, FileText, Filter, MessageSquare, Phone, Search } from 'lucide-react';
...
const resources: Resource[] = [
  {
    id: '1',
    title: { en: 'Poultry Biosecurity Complete Guide', hi: 'Poultry Biosecurity Complete Guide' },
    description: { 
  ...
  {
    id: '2',
    title: { en: 'Pig Farm Disease Prevention Manual', hi: 'Pig Farm Disease Prevention Manual' },
    description: { 
  ...
  {
    id: '3',
    title: { en: 'Emergency Response Checklist', hi: 'Emergency Response Checklist' },
    description: { 
...
const faqs = [
  {
    question: { en: 'How often should I clean my poultry house?', hi: 'Poultry house kitni baar saaf karna chahiye?' },
    answer: { en: 'Daily cleaning of feeding areas and water sources, with deep cleaning weekly.', hi: 'Feeding areas aur water sources daily saaf karein, aur weekly deep cleaning karein.' }
  },
  {
    question: { en: 'What should I do if I suspect disease in my animals?', hi: 'Agar mujhe lagta hai ki mere jaanwaron mein bimari hai to kya karna chahiye?' },
    answer: { en: 'Immediately isolate affected animals, contact your veterinarian, and report to local authorities.', hi: 'Turant affected jaanwaron ko isolate karein, veterinarian se contact karein, aur local authorities ko report karein.' }
  },
  {
    question: { en: 'How can I prevent visitors from spreading diseases?', hi: 'Visitors ko diseases spread karne se kaise rok sakte hain?' },
    answer: { en: 'Implement foot baths, provide protective clothing, maintain visitor logs, and restrict access to animal areas.', hi: 'Foot baths lagayein, protective clothing provide karein, visitor logs maintain karein, aur animal areas mein access restrict karein.' }
  }
];
            ...
            {[
              ...
              <button
                ...
                className={`flex-1 py-2 px-4 text-sm font-medium rounded-lg transition-colors ${
                  activeTab === tab.id ? 'bg-teal-600 text-white' : 'text-gray-600 hover:text-teal-600'
                }`}
              >
                {tab.label}
              </button>
        ...
        {activeTab === 'guides' && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredResources.map(resource => (
              <div key={resource.id} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group hover:-translate-y-1">
                <div className="p-6">
          ...
          <div className="space-y-6">
            {filteredFAQs.map((faq, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg p-6">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">{faq.question[language]}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 mb-4">
                  {language === 'en' ? '24/7 support for disease emergencies' : 'Disease emergencies ke liye 24/7 support'}
                </p>
                <div className="text-2xl font-bold text-teal-600 mb-4">1800-123-FARM</div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 mb-4">
                  {language === 'en' ? 'Report suspected disease outbreaks in your area' : 'Apne area mein suspected disease outbreaks report karein'}
                </p>
              </div>
              
              <form className="space-y-4">
                <label htmlFor="reportName" className="sr-only">Your Name</label>
                <input
                  id="reportName"
                  type="text"
                ...
                />
                <label htmlFor="reportLocation" className="sr-only">Farm Location</label>
                <input
                  id="reportLocation"
                  type="text"
                  ...
                  className="w-full p-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                />
                <label htmlFor="reportDescription" className="sr-only">Describe the suspected issue</label>
                <textarea
