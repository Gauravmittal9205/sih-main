...
import { ArrowLeft, User, Mail, Phone, Home, Shield, Calendar, Edit, Save, X, Camera, XCircle, Upload } from 'lucide-react';
...
const UserProfile: React.FC = () => {
  ...
  const handleImageUpload = async (file: File) => {
    ...
    try {
      const result = await authAPI.updateProfileImage(file);
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          <div className="flex items-center space-x-6">
            ...
            <div className="relative">
              {profileImage ? (
                ...
                <div className="w-24 h-24 rounded-full bg-gradient-to-br from-teal-500 to-blue-600 flex items-center justify-center text-white font-bold text-3xl border-4 border-white shadow-lg">
              ...
              {isEditing && (
                <div className="absolute inset-0 flex items-center justify-center">
                  <button
                    ...
                    className="w-full h-full bg-black bg-opacity-50 rounded-full flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-200"
          ...
          {isEditing && (
            <div className="mt-6">
              <div
                className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-teal-400 transition-colors duration-200"
